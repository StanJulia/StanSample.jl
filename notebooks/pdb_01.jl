...
data10_4 = (N = size(chimps, 1), N_actors = length(unique(chimps.actor)), 
...
begin
	df = DataFrame(load_values(ref))
	display(df)
end

# ╔═╡ bb9b378c-6d70-4d4d-bacd-d9d5a7b58e44
Array(df)

# ╔═╡ 65ca2a83-2692-4de8-87ca-af585b9cef11
v = Vector(Array(df)[1, 1])

# ╔═╡ bcacf439-9907-44c6-8613-5fb3a30a590a
length(v)

# ╔═╡ f4dc5579-eaeb-48b9-b50c-fcf010516577
Vector(Array(df)[10, 1])

# ╔═╡ 7a37d7ca-68fd-433e-af8c-2b494eb222f1
Vector(Array(df)[1, 2])

# ╔═╡ 95e5041c-1f96-4b9c-a2dc-ffde95fb4392
Matrix(df)
...
manifest_format = "2.0"
project_hash = "84b9ebfb75b77238d1f15138432ac1b1b96d52e5"
...
git-tree-sha1 = "51d31d4f1926b50b8b40d56d729b3e3841604a9c"
